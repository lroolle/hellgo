...
[[attachment:_20200726_151241screenshot.png]]

- Slice 的实现
 
[[attachment:_20200726_152019screenshot.png]]
...
-> More @ [[file:golang-gopath-gomod.org][go-mod-init]]
...
[[attachment:_20200728_023353screenshot.png]]
...
- more -> @[[file:src/deepdivego/errhandle/fib/fib.go::func writeFile(filename string) {][WriteFib]]

** 错误处理概念
-> src @[[file:src/deepdivego/errhandle/fib/fib.go::func writeFile(filename string) {][WriteFib]]
...
- 如何实现统一的错误处理方式？
  -> src @[[file:src/deepdivego/errhandle/filelistserver/web.go::func errWrapper(handler appHandler) func(http.ResponseWriter, *http.Request) {][errWrapper]]
...
* Chapter 08: Debuging sucks & Testing rocks 测试及性能调优
